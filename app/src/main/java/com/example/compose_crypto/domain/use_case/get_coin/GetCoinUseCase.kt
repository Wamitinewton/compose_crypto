package com.example.compose_crypto.domain.use_case.get_coin

import com.example.compose_crypto.common.Resource
import com.example.compose_crypto.data.remote.dto.toCoinDetail
        ...
        try {
            ...
            emit(
                Resource.Error<CoinDetail>(
                    e.localizedMessage ?: "An unexpected error has occured"
                )
            )
        } catch (e: IOException) {
